...
@Service
public class PractoScraperService implements SellerScraperService {
	...
	public SellerPrice getPrice(String buyURL) {
		LOGGER.info("PractoScraperService :: getPrice :: started :: {}", buyURL);
		...
		try {
			...
			LOGGER.error("PractoScraperService :: getPrice :: error", e);
			return null;
		} catch (Exception e) {
